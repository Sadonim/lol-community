...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('COMMENT_REPLY', 'POST_VOTE', 'COMMENT_VOTE', 'SYSTEM');
...
-- CreateIndex
CREATE INDEX "RiotAccount_tier_rank_leaguePoints_idx" ON "RiotAccount"("tier", "rank", "leaguePoints");
